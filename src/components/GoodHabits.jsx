function GoodHabits() {
  return (
    <section className="mx-auto mt-[71.61px] max-w-[1440px] md:mt-[96px]">
      <div className="flex flex-col gap-10 bg-opacity-25 bg-gradient-1 py-14 pl-[19px] pr-[29px] md:py-[60px] md:pl-[39px] md:pr-[43px] lg:flex-row lg:gap-8 lg:pb-[96px] lg:pl-[116px] lg:pr-[117px] lg:pt-[72px] xl:mx-6 xl:rounded-[35px]">
        {/* one habit */}
        <div className="flex flex-col gap-8 md:flex-row md:items-center md:gap-10 lg:flex-col lg:items-start lg:gap-[45px]">
          <svg
          ...
          <div className="flex flex-col gap-6">
            <h3 className="text-2xl font-semibold leading-none tracking-[-1.2px] text-gunmetal">
              Healthy eating
            </h3>
